...
/**
 * Calendar component that uses react-day-picker.
 * See https://react-day-picker.js.org/docs/getting-started.
	...
	return (
		<DayPicker
			...
			classNames={{
				...
				day_today: "outline outline-accent text-accent-foreground",

...
export default function JobRecordLoadingSkeleton() {
	return (
		<div role="status" className="animate-pulse">
			<div className={'grid grid-cols-1 xl:grid-cols-3 xl:space-x-4'}>
				<div className={'col-span-2 border-r-2 space-y-4 '}>
					<div className={'grid grid-cols-3 gap-4 mr-6 mt-2'}>
					...
					<div className={'mr-6'}>
						<div className="h-6 bg-gray-300 rounded-md w-full mb-2"></div>
						<div className="h-6 bg-gray-300 rounded-md w-full mb-2"></div>
						<div className="h-6 bg-gray-300 rounded-md w-full mb-2"></div>
						<div className="h-6 bg-gray-300 rounded-md w-full mb-2"></div>
						<div className="h-6 bg-gray-300 rounded-md w-full mb-2"></div>

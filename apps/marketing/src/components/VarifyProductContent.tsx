...
export default function VarifyProductContent() {
    return (
        <div id={'varify'} className="relative isolate overflow-hidden bg-white px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0">
                    ...
                    <div className="lg:pr-4">
                        <div className="lg:max-w-lg">
                            <div className="flex items-center">
                                ...
                                <p className="text-2xl font-semibold leading-7 text-indigo-600 ml-2 lg:ml-4">
                                    Varify
                                </p>
                            </div>
